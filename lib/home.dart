...
class _ThirdRoute extends State {
  ...
  Widget build(BuildContext context) {
    ...
    flutterTts.speak("Welcome Back Soumyadip. Are you ready for your session?");
    return Scaffold(
        backgroundColor: Color(0xdd5A84FA),
        appBar: AppBar(
          title: Text("Dash"),
        ),
        body: Center(
                        ...
                        onPressed: () {
                          ...
                          showDialog(
                              ...
                              builder: (_) => new AlertDialog(
                                  backgroundColor: Color(0xdd5A84FA),
                                  title: new Text("Monthly Fee: 10 USD"),
